...
export const constantRoutes = [
  ...
  },
  {
    ...
    component: Layout,
    redirect: '/core/integral-grade/list', //当访问path路径时，会自动跳转到该url
    name: 'coreIntegralGrade', //每个路由节点的name的名字不能相同
    meta: { title: '积分等级管理', icon: 'el-icon-s-marketing' }, //指向template模板组件
    alwaysShow: true, //false当且仅当父节点下只有一个子节点时不显示父节点,默认为false
    children: [
      {
        path: 'list',
